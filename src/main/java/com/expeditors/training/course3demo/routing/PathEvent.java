...
/**
* An encapsulation of the data describing an event related to a {@link PathFinder}.
*
...
public abstract class PathEvent<T extends Node> extends EventObject {
  ...
  *
  * @return the path related to the event in the form of a {@link java.util.List} of {@link Node}s or <tt>null</tt> if no path
  * was found
  */
